  ...
  return (
    <div className="flex nav:flex-row flex-col gap-5 gap-y-32 nav:mt-60 mt-32 h-full">
      <div className={`relative ${data.third.id!==currentUser?'Topbg':'TopbgCurrent'} w-[300px] h-[230px] nav:order-1 order-3 flex justify-center items-center`}>
        {data.third.id && <img style={{boxShadow:'0px 14px 100px 0px #C47A31'}} className='w-24 rounded-2xl absolute -top-32' src={data.third.img} alt="" />}
      ...
      {data.first.id && <img style={{boxShadow:'0px 14px 100px 0px #F6CB01'}} className='w-24 rounded-2xl absolute -top-32' src={data.first.img} alt="" />}
      ...
      {data.second.id && <img style={{boxShadow:'0px 14px 100px 0px #B6B5B5'}} className='w-24 rounded-2xl absolute -top-32' src={data.second.img} alt="" />}
